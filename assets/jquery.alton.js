      ...
      (function($) {
        ...
        $.fn.alton = function(options) {
          ...
          function slideIndex(element, toggle) {
            var slideElement = $(slideNumbers[$(element).parent().children().index(element)]);
            if (toggle && slideElement.hasClass('active')) {
              slideElement.toggleClass('active');
              slideElement.css('background', settings.slideNumbersBorderColor);
            } else if (!slideElement.hasClass('active')) {
              slideElement.toggleClass('active');
              slideElement.css('background', settings.slideNumbersColor);
            }
          }
